...
@section('content')
    <form action="{{ route('backend.product.category.added', ['id' => $id]) }}" method="post">
        @csrf
            ...
            <div class="tab-content tabs-alpha__tab-content">
                <div class="tab-pane active show" id="tab1" role="tabpanel" aria-expanded="true">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" class="write-seo form-control" id="name" data-seo_id="seo_name"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <select name="attribute_id[]" class="form-control selectbox global-select2" multiple
                                    ...
                                    data-selected="{{ json_encode(old('attribute_id')) }}">
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input readonly type="text" name="seo_name" value="{{ old('seo_name') }}" class="form-control" id="seo_name"/>
                ...
                <div class="tab-pane" id="tab3" role="tabpanel" aria-expanded="true">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="form-group filemanager-image">
                            <input type="hidden" name="image2" class="imagepath" value="{{ old('image2') }}" />
                            <img src="{{ Storage::disk('public')->url(old('image2')) }}" width="100" height="100" class="img-thumbnail preview" />
                            <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                <button type="button" class="btn btn-danger btn-remove"><span class="ua-icon-remove"></span></button>
                            </div>
                        </div>
                        <div class="form-group filemanager-image">
                            <input type="hidden" name="image3" class="imagepath" value="{{ old('image3') }}" />
                            <img src="{{ Storage::disk('public')->url(old('image3')) }}" width="100" height="100" class="img-thumbnail preview" />
                            <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                <button type="button" class="btn btn-danger btn-remove"><span class="ua-icon-remove"></span></button>
                            </div>
                        </div>
