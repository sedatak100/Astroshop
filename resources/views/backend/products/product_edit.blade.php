...
@section('content')
    <form action="{{ route('backend.product.edited', ['id' => $product->id()]) }}" method="post">
        @csrf
                ...
                <div class="tab-pane active show" id="tab1" role="tabpanel" aria-expanded="true">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name', $product->name) }}" class="write-seo form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" data-seo_id="seo_name" />
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="short_description" class="form-control{{ $errors->has('short_description') ? ' is-invalid' : '' }}" id="short_description">{{ old('short_description', $product->short_description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="ckeditor{{ $errors->has('description') ? ' is-invalid' : '' }}">{{ old('description', $product->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="order" value="{{ old('order', $product->order) }}" class="form-control{{ $errors->has('order') ? ' is-invalid' : '' }}" id="order"/>
                            @if ($errors->has('order'))
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control{{ $errors->has('status') ? ' is-invalid' : '' }}">
                                <option @if(old('status', $product->status) == "0") selected
                                        @endif value="0">@lang('backend/common.status_0')</option>
                                <option @if(old('status', $product->status) == "1") selected
                ...
                <div class="tab-pane" id="tab2" role="tabpanel" aria-expanded="true">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" readonly name="seo_name" value="{{ old('seo_name', $product->seo_name) }}" class="form-control{{ $errors->has('seo_name') ? ' is-invalid' : '' }}" id="seo_name"/>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_title" class="form-control{{ $errors->has('meta_title') ? ' is-invalid' : '' }}" id="meta_title">{{ old('meta_title', $product->meta_title) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_description" class="form-control{{ $errors->has('meta_description') ? ' is-invalid' : '' }}" id="meta_description">{{ old('meta_description', $product->meta_description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_keyword" class="form-control{{ $errors->has('meta_keyword') ? ' is-invalid' : '' }}" id="meta_keyword">{{ old('meta_keyword', $product->meta_keyword) }}</textarea>
                ...
                <div class="tab-pane" id="tab3" role="tabpanel" aria-expanded="true">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="model" value="{{ old('model', $product->model) }}" class="form-control{{ $errors->has('model') ? ' is-invalid' : '' }}" id="model"/>
                            @if ($errors->has('model'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="stock_code" value="{{ old('stock_code', $product->stock_code) }}" class="form-control{{ $errors->has('stock_code') ? ' is-invalid' : '' }}" id="stock_code"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="barcode" value="{{ old('barcode', $product->barcode) }}" class="form-control{{ $errors->has('barcode') ? ' is-invalid' : '' }}" id="barcode"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="serial_no" value="{{ old('serial_no', $product->serial_no) }}" class="form-control{{ $errors->has('serial_no') ? ' is-invalid' : '' }}" id="serial_no"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="serial_no2" value="{{ old('serial_no2', $product->serial_no2) }}" class="form-control{{ $errors->has('serial_no2') ? ' is-invalid' : '' }}" id="serial_no2"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="serial_no3" value="{{ old('serial_no3', $product->serial_no3) }}" class="form-control{{ $errors->has('serial_no3') ? ' is-invalid' : '' }}" id="serial_no3"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="price" value="{{ old('price', $product->price) }}" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" id="price"/>
                            @if ($errors->has('price'))
                        ...
                        <div class="form-group">
                            ...
                            <select name="currency_id" id="currency_id" class="form-control{{ $errors->has('currency_id') ? ' is-invalid' : '' }}">
                                @foreach($currencies as $currency)
                                    <option @if(old('currency_id', $product->currency_id) == $currency->id()) selected @endif value="{{ $currency->id() }}">{{ $currency->name }} ({{ $currency->code }})</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="quantity" value="{{ old('quantity', $product->quantity) }}" class="form-control{{ $errors->has('quantity') ? ' is-invalid' : '' }}" id="quantity"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="min_quantity" value="{{ old('min_quantity', $product->min_quantity) }}" class="form-control{{ $errors->has('min_quantity') ? ' is-invalid' : '' }}" id="min_quantity"/>
                        ...
                        <div class="form-group">
                            ...
                            <select name="subtract" id="subtract" class="form-control{{ $errors->has('subtract') ? ' is-invalid' : '' }}">
                                <option @if(old('subtract', $product->subtract) == "1") selected
                                        @endif value="1">@lang('backend/common.yes')</option>
                                <option @if(old('subtract', $product->subtract) == "0") selected
                        ...
                        <div class="form-group">
                            ...
                            <select name="stock_status_id" id="stock_status_id" class="form-control{{ $errors->has('stock_status_id') ? ' is-invalid' : '' }}">
                                @foreach($stock_statuses as $stock_status)
                                    <option @if(old('stock_status_id', $product->stock_status_id) == $stock_status->id()) selected @endif value="{{ $stock_status->id() }}">{{ $stock_status->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="shipping" id="shipping" class="form-control{{ $errors->has('shipping') ? ' is-invalid' : '' }}">
                                <option @if(old('shipping', $product->shipping) == "1") selected
                                        @endif value="1">@lang('backend/common.yes')</option>
                                <option @if(old('shipping', $product->shipping) == "0") selected
                                        @endif value="0">@lang('backend/common.no')</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="tax_class_id" id="tax_class_id" class="form-control{{ $errors->has('tax_class_id') ? ' is-invalid' : '' }}">
                                ...
                                @foreach($tax_classes as $tax_class)
                                    <option @if(old('tax_class_id', $product->tax_class_id) == $tax_class->id()) selected @endif value="{{ $tax_class->id() }}">{{ $tax_class->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group datepicker">
                                <input type="text" name="date_available" value="{{ old('date_available', $product->date_available) }}" class="form-control datepicker{{ $errors->has('date_available') ? ' is-invalid' : '' }}" id="date_available" data-input/>
                                <div class="input-group-append">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="length" value="{{ old('length', $product->length) }}" class="form-control{{ $errors->has('length') ? ' is-invalid' : '' }}" id="length" placeholder="Uzunluk"/>
                                <div class="input-group-append">
                                    <input type="text" name="width" value="{{ old('width', $product->width) }}" class="form-control{{ $errors->has('width') ? ' is-invalid' : '' }}" id="width" placeholder="Genişlik"/>
                                </div>
                                <div class="input-group-append">
                                    <input type="text" name="height" value="{{ old('height', $product->height) }}" class="form-control{{ $errors->has('height') ? ' is-invalid' : '' }}" id="height" placeholder="Yükselik"/>
                                </div>
                                <div class="input-group-append">
                                    <select name="length_id" id="length_id" class="form-control{{ $errors->has('length_id') ? ' is-invalid' : '' }}">
                                        @foreach($lengths as $length)
                                            <option @if(old('length_id', $product->length_id) == $length->id()) selected @endif value="{{ $length->id() }}">{{ $length->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="weight" value="{{ old('weight', $product->weight) }}" class="form-control{{ $errors->has('weight') ? ' is-invalid' : '' }}" id="weight" placeholder="Ağırlık"/>
                                <div class="input-group-append">
                                    <select name="weight_id" id="weight_id" class="form-control{{ $errors->has('weight_id') ? ' is-invalid' : '' }}">
                                        @foreach($weights as $weight)
                                            <option @if(old('weight_id', $product->weight_id) == $weight->id()) selected @endif value="{{ $weight->id() }}">{{ $weight->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="brand_id" id="brand_id" class="form-control global-select2"
                                    ...
                                    data-selected="{{ json_encode(old('brand_id', $product->brand_id)) }}">
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="category_id[]" id="category_id" class="form-control global-select2" multiple
                                    ...
                                    data-selected="{{ json_encode(old('category_id', $product->categories->pluck('category_id')->toArray())) }}">
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="download_id[]" id="download_id" class="form-control global-select2" multiple
                                    ...
                                    data-selected="{{ json_encode(old('download_id', $product->downloads->pluck('download_id')->toArray())) }}">
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="icon_id[]" id="icon_id" class="form-control global-select2" multiple
                                    ...
                                    data-selected="{{ json_encode(old('icon_id', $product->icons->pluck('icon_id')->toArray())) }}">
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="filter_id[]" id="filter_id" class="form-control global-select2" multiple
                                    ...
                                    data-selected="{{ json_encode(old('filter_id', $product->filters->pluck('filter_id')->toArray())) }}">
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="similar_id[]" id="similar_id" class="form-control global-select2" multiple
                                    ...
                                    data-selected="{{ json_encode(old('similar_id', $product->similars->pluck('similar_id')->toArray())) }}">
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="similar_product_id">Etiketler</label>
                            <div class="tag-editor"> <!-- need wrap -->
                                <input name="tag" value="{{ old('tag', $product->tags->implode('name', ',')) }}" class="form-control" placeholder="virgül ile ayırarak giriniz." />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                            <table class="table table-striped table-bordered" id="table-attribute">
                                ...
                                <tbody>
                                @if(old('attribute', $product->attributes->count()))
                                    @foreach(old('attribute', $product->attributes->toArray()) as $i => $attribute)
                                        <tr>
                                            <td>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                            <table class="table table-striped table-bordered" id="table-discount">
                                ...
                                <tbody>
                                @if(old('discount', $product->discounts->count()))
                                    @foreach(old('discount', $product->discounts->toArray()) as $i => $discount)
                                        <tr>
                                            <td>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                            <table class="table table-striped table-bordered" id="table-campaign">
                                ...
                                <tbody>
                                @if(old('campaign', $product->campaigns->count()))
                                    @foreach(old('campaign', $product->campaigns->toArray()) as $i => $campaign)
                                        <tr>
                                            <td>
                ...
                <div class="tab-pane" id="tab8" role="tabpanel" aria-expanded="true">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group filemanager-image">
                            <input type="hidden" name="main_image" class="imagepath" value="{{ old('main_image', $product->image) }}" />
                            <img src="{{ Storage::disk('public')->url(old('main_image', $product->image)) }}" width="100" height="100" class="img-thumbnail preview" />
                        ...
                        @foreach($product->images as $i => $image)
                            <div class="form-group filemanager-image">
                                <input type="hidden" name="image[{{ $i }}][path]" class="imagepath" value="{{ old('image.' . $i . '.path', $image->image) }}" />
                                <img src="{{ Storage::disk('public')->url(old('image.' . $i . '.path', $image->image)) }}" width="100" height="100" class="img-thumbnail preview" />
                                <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                    <button type="button" class="btn btn-danger btn-remove"><span class="ua-icon-remove"></span></button>
                                    <input type="text" name="image[{{ $i }}][order]" value="{{ old('image.' . $i . '.order', $image->order) }}" class="form-control" size="1" placeholder="Sıra" />
                                </div>
                            </div>
                        @endforeach
                        @endif
                        @for($i=$product->images->count(); $i<config('config.product_image_limit'); $i++)
                        <div class="form-group filemanager-image">
                            ...
                            <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                <button type="button" class="btn btn-danger btn-remove"><span class="ua-icon-remove"></span></button>
                                <input type="text" name="image[{{ $i }}][order]" value="{{ old('image.' . $i . '.order') }}" class="form-control" size="1" placeholder="Sıra" />
                            </div>
                        </div>
                        @endfor
                    </div>
