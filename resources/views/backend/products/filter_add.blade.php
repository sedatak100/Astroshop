...
@section('content')
    <form action="{{ route('backend.product.filter.added') }}" method="post">
        @csrf
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="form-group">
                            <table class="table table-striped table-bordered" id="table-filter">
                                ...
                                <tbody>
                                @if(old('filter'))
                                @foreach(old('filter') as $i => $filter)
                                    <tr>
                                        <td><input type="text" name="filter[{{ $i }}][name]" value="{{ $filter['name'] }}" class="form-control" /></td>
                                        <td>
                                ...
                                @else
                                    <tr>
                                        <td><input type="text" name="filter[0][name]" value="" class="form-control" /></td>
                                        <td>
