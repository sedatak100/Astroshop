...
@section('content')
    <div class="main-container">
        <form action="{{ route('backend.coupon.added') }}" method="post">
            @csrf
            <div class="col-lg-6 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select name="product_id[]" id="product_id" class="form-control global-select2" multiple
                            ...
                            data-selected="{{ json_encode(old('product_id')) }}">
                    </select>
                </div>
                -->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="uses_total" value="{{ old('uses_total') }}" class="form-control"
                           id="uses_total"/>
                </div>
                <div class="form-group">
                    <label for="uses_customer">Müşteri Başına Toplam Kullanım</label>
                    <input type="text" name="uses_customer" value="{{ old('uses_customer') }}" class="form-control"
                           id="uses_customer"/>
                </div>
